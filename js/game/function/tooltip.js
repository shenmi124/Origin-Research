function tooltip(id){
	...
	if(id=='ResearchResourceOtherTooltip'){
		return getTooDoc('<a style="color: var(--researchColor);text-shadow: 3px 3px 2px var(--researchColor);">填 充 物 质</a><hr><small>填充你 '+formatScientific(player.barToggle,0)+'% 的 '+colorText(player.ResearchItem)[2]+'<hr><small>'+colorText(player.ResearchItem)[2]+':质量'+main['resource'][player.ResearchItem]['PR']()[0]+' 研究价值'+main['resource'][player.ResearchItem]['PR']()[1]+' 总研究价值'+n(main['resource'][player.ResearchItem]['PR']()[0]).mul(main['resource'][player.ResearchItem]['PR']()[1])+'<hr>你将会填充:'+format(player[player.ResearchItem].mul(player.barToggle.mul(0.01)).min(player.researchBarMax.sub(player.researchBar).div(main['resource'][player.ResearchItem]['PR']()[0])))+'('+format(player[player.ResearchItem].mul(main['resource'][player.ResearchItem]['PR']()[0]).mul(player.barToggle.mul(0.01)).min(player.researchBarMax.sub(player.researchBar).div(main['resource'][player.ResearchItem]['PR']()[0])))+'质量)'+colorText(player.ResearchItem)[2]+'<br>你将会获得:'+format(player[player.ResearchItem].mul(main['resource'][player.ResearchItem]['PR']()[0]).mul(player.barToggle.mul(0.01)).min(player.researchBarMax.sub(player.researchBar).div(main['resource'][player.ResearchItem]['PR']()[0])).mul(main['resource'][player.ResearchItem]['PR']()[1]))+colorText('researchPoint')[2])
	}
